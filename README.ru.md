...
> ⚠️ **Пользователи OpenCode:** В настоящее время Prompapa не поддерживает боковую панель OpenCode. Запускайте OpenCode с отключенной боковой панелью. Мы исправим это в ближайшее время!
...
> **Примечание:** При использовании `papa opencode` сначала отключите вид боковой панели. Prompapa не может правильно изолировать область ввода, когда боковая панель открыта, что вызывает ошибки перевода.
